IF OBJECT_ID('[unit_tests].[test movies_get get by id]') IS NOT NULL
    DROP PROCEDURE [unit_tests].[test movies_get get by id];
GO

-- test that movies_get gets the movie by id
CREATE PROCEDURE [unit_tests].[test movies_get get by id]
AS
BEGIN
    --Assemble
    ...
    EXEC dbo.movies_get @id = @id, @title = NULL, @owned = NULL;
