IF OBJECT_ID('[unit_tests].[test series_get get by id]') IS NOT NULL
    DROP PROCEDURE [unit_tests].[test series_get get by id];
GO

-- test that series_get gets the series by id
CREATE PROCEDURE [unit_tests].[test series_get get by id]
AS
BEGIN
    --Assemble
    ...
    EXEC dbo.series_get @id = @id, @title = NULL, @owned = NULL;
