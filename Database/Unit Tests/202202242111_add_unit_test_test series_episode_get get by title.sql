IF OBJECT_ID('[unit_tests].[test series_episode_get get by title]') IS NOT NULL
    DROP PROCEDURE [unit_tests].[test series_episode_get get by title];
GO

-- test that series_episode_get gets the series episode by title
CREATE PROCEDURE [unit_tests].[test series_episode_get get by title]
AS
BEGIN
    --Assemble
    ...
    EXEC dbo.series_episode_get @id = NULL, @title = @title, @owned = NULL, @series_id = NULL;
