IF OBJECT_ID('[unit_tests].[test series_by_released_date_get get get by date range]') IS NOT NULL
    DROP PROCEDURE [unit_tests].[test series_by_released_date_get get get by date range];
GO

-- test that series_by_released_date_get gets all the owned series
CREATE PROCEDURE [unit_tests].[test series_by_released_date_get get get by date range]
AS
BEGIN
    --Assemble
    ...
    EXEC dbo.series_by_released_date_get @from_date = @from_date, @to_date = @to_date;
